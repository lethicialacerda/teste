...
class _MenuState extends State<Menu> with SingleTickerProviderStateMixin {
  ...
  void initState(){
    super.initState();
    _tabController = TabController(length: comidaCategoria.values.length, vsync: this);
  }
  ...
  List<Comida> _filtrarMenuCategoria(comidaCategoria categoria, List <Comida> todoMenu){
    ...
    return comidaCategoria.values.map((categoria){
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            title: Text(menuCategoria[index].nome),
          );
        },
      );
    }).toList();
        ...
        body: Container(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Consumer<Padaria>(builder: (context, padaria, child) => TabBarView(
